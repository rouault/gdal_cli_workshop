...
This workshop will give participants the opportunity to discover the capabilities of the new CLI through a series of hands-on exercises, including how to leverage those capabilities from Python.

Target audience
---------------

Suitable for those new to GDAL, as well as those already experienced with the traditional utilities and wishing to become proficient with the new CLI. Participants should not be afraid of command line use!

Some familiarity with geospatial raster and vector data and coordinate systems is assumed but not strictly required.

Some SQL and Python knowledge will be useful for advanced exercises.
